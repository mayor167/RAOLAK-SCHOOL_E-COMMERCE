...
<body>
   ...
   <div class="how_to_register">
    ...
    <div class="col_steps">
        <h1>Step 1.</h1>
    <p><b>Create an Account: </b>Look for a "Register button" or "How_to_Reg icon" on the nav-bar. Fill out the registration form with your basic information and choose a secure password.</p>
    <br><br><br><br>
    <h1>Step 2.</h1>
    <p><b>Load Your E-Wallet:</b> Locate the "E-Wallet" or "Top Up" section. Choose your preferred method to add funds to your e-wallet, like bank transfer or debit card. Follow the on-screen instructions to complete the transaction.</p>
    <br><br><br>
    <h1>Step 3.</h1>
    <p><b>Shop & Pay with Ease:</b> Browse the website for items you like. Once you've added them to your cart, proceed to checkout. Select "E-Wallet" as your payment method and confirm your purchase. Enjoy the convenience of secure and speedy checkout!</p>
    </div>
    <div class="col_means_of_payment">
        <img src="index_images/procedure.png" alt="procdures">
    </div>
    </div>
   </div>
